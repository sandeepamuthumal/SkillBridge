...
adminRouter.get('/users/employers', getEmployers);
adminRouter.patch('/users/employers/:id/status', updateEmployerStatus);
adminRouter.patch('/users/employers/:id/reset-password', adminResetEmployerPassword);
